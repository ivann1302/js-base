...
export const IconGallery = ({ className }: { className?: string }) => {
  return (
    <div className={`${styles.iconGallery} ${className}`}>
      ...
      <Icon width={64} height={64} path={icons.javascript} alt='JavaScript' />
      <Icon width={64} height={64} path={icons.typescript} alt='TypeScript' />
      <Icon width={64} height={64} path={icons.react} alt='React' />
      <Icon width={64} height={64} path={icons.network} alt='Network' />
